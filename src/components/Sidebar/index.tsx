...
import { useGetProjectsQuery } from "@/redux/state/api";
import { 
    AlertCircle, 
    AlertOctagon, 
    AlertTriangle, 
            ...
            <div className="flex h-[100%] w-full flex-col justify-start">
                ...
                <div className="z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black">
                    ...
                    {isSidebarCollapsed ? null : (
                        <button className="py-3 cursor-pointer" onClick={() => dispatch(setIsSidebarCollapsed(!isSidebarCollapsed))}>
                ...
                <button onClick={() => setShowProjects((prev)=> !prev)}
                    className="flex w-full cursor-pointer items-center justify-between px-8 py-3 text-gray-300">
                ...
                {/* PROJECT LIST */}
                {
                    showProjects && projects?.data.map((project)=>(
                        <SidebarLink
                            key={project.id}
                            icon={Briefcase}
                            label={project.name}
                ...
                </button>
                {
                    showPriority && (
                        <>
                            ...
                            <SidebarLink icon={Layers3} label="Medium" href="/priority/backlog" />
                        </>
