...
const TabButton = ({name,icon,setActiveTab,activeTab}:TabButtonProps) => {
    ...
    return(
        ...
        text-gray-500 after:absolute after:-bottom-[9px] after:left-0 after:h-[1px] 
        after:w-full hover:text-blue-600 dark:text-neutral-500 dark:hover:text-white sm:px-2 lg:px-4 ${
